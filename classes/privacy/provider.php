...
/**
 * Privacy Subsystem implementation for format_pathway.
 *
...
namespace format_pathway\privacy;
...
/**
 * Privacy provider for format_pathway.
 *
 * The Pathway format stores a single user preference for sidebar
 * collapsed state. This is handled by core's user preferences
 * privacy provider. The plugin does not store any other personal data.
 *
 * @package   format_pathway
 * @copyright 2025 Your Company
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_user_preference(
            'format_pathway_sidebar_collapsed',
            'privacy:metadata:preference:sidebar_collapsed'
        );
        return $collection;
    }
